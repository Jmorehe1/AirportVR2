...
model_desired = "migleolop/Sep1FineTune" # "garrachonr/LlamaDos" # "meta-llama/Llama-2-13b-chat-hf" # "brockwilson12/Llama2-8bit" # "clibrain/Llama-2-7b-ft-instruct-es"
# "meta-llama/Llama-2-7b-chat-hf"
# "migleolop/Sep1FineTune"
...
#model = AutoModelForCausalLM.from_pretrained(model_desired,device_map='auto', quantization_config = bnb_config)

model = AutoModelForCausalLM.from_pretrained(model_desired, torch_dtype=torch.float16).to("cuda")
#model = AutoModelForCausalLM.from_pretrained(model_desired, torch_dtype=torch.float16).to("cpu")


# tokenizer_with_prefix_space = AutoTokenizer.from_pretrained(model_desired, add_prefix_space=True) # ERROR HERE 9/19
tokenizer_with_prefix_space = AutoTokenizer.from_pretrained("meta-llama/Llama-2-7b-chat-hf")
